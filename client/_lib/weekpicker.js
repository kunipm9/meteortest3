...
console.log(e.target);
                    if (e.target.className == 'box0' || e.target.className == 'box1') {
                        pi.hide();
                    }
                })
        ...
        format:function (date) {
            ...
            return date.getFullYear().toString() + '-' + month + '-' + dom;
        },
        ...
        nav:function (months) {
            var $subnav = $('<div>' +
                '<span class="prev button">&larr; Prev </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
    ...
    $(document).ready(function () {
        ...
        $.fn.weekpicker.defaults = {
            monthNames:["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "100月", "11月", "12月"],
